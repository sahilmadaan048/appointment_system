...
var CreateAvailabilityDto = function () {
    var _a;
    ...
    return _a = /** @class */ (function () {
            function CreateAvailabilityDto() {
        ...
        (function () {
            ...
            _startTime_decorators = [(0, swagger_1.ApiProperty)({ description: 'ISO date-time string' }), (0, class_validator_1.IsISO8601)()];
            _endTime_decorators = [(0, swagger_1.ApiProperty)({ description: 'ISO date-time string' }), (0, class_validator_1.IsISO8601)()];
