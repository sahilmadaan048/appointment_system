...
var AppointmentsController = function () {
    var _classDecorators = [(0, swagger_1.ApiTags)('appointments'), (0, swagger_1.ApiBearerAuth)(), (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, roles_guard_1.RolesGuard), (0, common_1.Controller)('appointments')];
    ...
    var AppointmentsController = _classThis = /** @class */ (function () {
        function AppointmentsController_1(apptService) {
            this.apptService = (__runInitializers(this, _instanceExtraInitializers), apptService);
        }
        AppointmentsController_1.prototype.book = function (req, dto) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    ...
                    return [2 /*return*/, this.apptService.book(studentId, dto)];
                });
            });
        };
        AppointmentsController_1.prototype.myAppointments = function (req) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.apptService.findForUser(req.user.userId, req.user.role)];
                });
            });
        };
        AppointmentsController_1.prototype.cancel = function (req, id) {
            return __awaiter(this, void 0, void 0, function () {
                var professorId;
                return __generator(this, function (_a) {
                    professorId = req.user.userId;
                    return [2 /*return*/, this.apptService.cancel(professorId, +id)];
                });
            });
        };
    ...
    (function () {
        ...
        _book_decorators = [(0, common_1.Post)(), (0, roles_decorator_1.Roles)(role_enum_1.Role.Student), (0, swagger_1.ApiOperation)({ summary: 'Book an appointment (Student only)' })];
        _myAppointments_decorators = [(0, common_1.Get)(), (0, roles_decorator_1.Roles)(role_enum_1.Role.Student, role_enum_1.Role.Professor), (0, swagger_1.ApiOperation)({ summary: 'View your active apppointments' })];
        _cancel_decorators = [(0, common_1.Patch)(':id/cancel'), (0, roles_decorator_1.Roles)(role_enum_1.Role.Professor)];
