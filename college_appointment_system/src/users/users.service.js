...
var UsersService = function () {
    ...
    var UsersService = _classThis = /** @class */ (function () {
        function UsersService_1(usersRepo) {
            this.usersRepo = usersRepo;
        }
        UsersService_1.prototype.create = function (name, email, password, role) {
            return __awaiter(this, void 0, void 0, function () {
                var hash, roleEnum, user;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, bcrypt.hash(password, 10)];
                        case 1:
                            hash = _a.sent();
                            roleEnum = role === 'student' ? role_enum_1.Role.Student : role_enum_1.Role.Professor;
                            user = this.usersRepo.create({ name: name, email: email, password: hash, role: roleEnum });
        ...
        UsersService_1.prototype.findByEmail = function (email) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.usersRepo.findOne({ where: { email: email } })];
                });
            });
        };
        UsersService_1.prototype.findById = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.usersRepo.findOne({ where: { id: id } })];
                });
            });
        };
