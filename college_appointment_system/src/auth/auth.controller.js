...
var AuthController = function () {
    var _classDecorators = [(0, swagger_1.ApiTags)(), (0, common_1.Controller)('auth')];
    ...
    var AuthController = _classThis = /** @class */ (function () {
        ...
        AuthController_1.prototype.register = function (dto) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.authService.register(dto.name, dto.email, dto.password, dto.role)];
                        case 1:
                            user = _a.sent();
        ...
        AuthController_1.prototype.login = function (dto) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.authService.login(dto.email, dto.password)];
                });
            });
        };
    ...
    (function () {
        ...
        _register_decorators = [(0, common_1.Post)('register'), (0, swagger_1.ApiOperation)({ summary: 'Register as Student or Professor' })];
        _login_decorators = [(0, common_1.Post)('login'), (0, swagger_1.ApiOperation)({ summary: 'Login and receive JWT Token' })];
